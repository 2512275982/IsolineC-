...
namespace DrawLineInArcGIS
{
    ...
    public class TestIsoline
    {
        public static GridIsoline ReadJsonFile()
        {
            ...
            List<IsoPolygonInfo> listPolys = gridIsoline.WikiIsolineBand(listLines, gridClass.Ymax, gridClass.Ymin, gridClass.Xmax, gridClass.Xmin);
            return gridIsoline;
